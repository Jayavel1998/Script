Feature: To Validating the FASoft Supplier Module

  @supplier
  Scenario Outline: User should verify the Supplier  Module
    ...
    When User should click Supplier on Master
    Then User should verify the Supplier List page and title of  "Supplier List"
